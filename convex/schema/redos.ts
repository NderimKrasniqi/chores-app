...
export const redoTables = {
  choreRedos: defineTable({
     ...
     */
    initialSubmissionId: v.id("choreSubmissions"),

    /*
     * The authoritative rejected Review
     * that created this Redo opportunity.
     */
    rejectionReviewId: v.id("choreReviews"),
    ...
    .index("by_rejection_review", ["rejectionReviewId"])

    .index("by_deadline", ["deadlineAt"])

    .index("by_household_deadline", ["householdId", "deadlineAt"]),
};
