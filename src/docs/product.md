...
- Parents configure one weekly unclaim allowance that applies equally to all children; after a child exhausts it, that child may continue claiming but cannot unclaim further chores during that payout week. If a Parent changes the allowance, the new limit applies to later unclaim decisions immediately and does not reset usage already consumed during the open payout week.
