...
import { HouseholdCard, type HouseholdSummary } from './household-card';
...
export function HouseholdListScreen({
  ...
  return (
    ...
    >
      ...
      <Text className="mt-1 text-2xl font-bold text-white">{parentName}</Text>

      <Text className="mt-1 text-slate-400">{parentEmail}</Text>
