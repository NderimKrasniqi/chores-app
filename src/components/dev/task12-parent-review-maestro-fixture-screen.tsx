...
const SUBMISSION_ID = "task12-parent-submission" as Id<"choreSubmissions">;

const CLAIM_ID = "task12-parent-claim" as Id<"choreClaims">;

const OCCURRENCE_ID = "task12-parent-occurrence" as Id<"choreOccurrences">;

const CHILD_ID = "task12-parent-child" as Id<"children">;
...
const fixtureReview: ClaimableChoreReviewViewModel = {
  ...
  submittedAt: Date.UTC(2030, 0, 15, 16, 30, 0),
  ...
  return (
    ...
    >
      ...
      <Text className="mt-2 text-sm leading-5 text-slate-400">
        Deterministic Claimable approval and earning presentation.
      </Text>
      ...
      <ClaimableChoreReviewsView
        ...
        onApprove={async (submissionId) => {
          if (submissionId !== SUBMISSION_ID) {
            throw new Error("Unexpected TASK-12 submission.");
          }
